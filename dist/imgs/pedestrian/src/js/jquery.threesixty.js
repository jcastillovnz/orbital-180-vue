    ...
    var scope,
        ...
        $.fn.nextFrame = ThreeSixty.prototype.nextFrame = function(){
            ...
            $(this).each(function(i){
                ...
                $this.find('.labels').css({visibility: 'hidden'});
    ...
    //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        ThreeSixty.prototype.onMove = function(screenX, screenY){
            if(isMouseDown){
                ...
                $downElem.find('.labels').css({visibility: 'hidden'});
                $downElem.find('.labels:eq(' + val + ')').css({display: 'block'}).css({visibility: 'visible'});
